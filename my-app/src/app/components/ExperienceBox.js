export default function ExperienceBox( { date, company, role, description, skills } ) {
	return (
    <div className = 'w-full flex flex-row space-x-4'>
      <div className = 'w-1/4 SlateFont text-xs'>
        {date}
      </div>
      <div className = 'w-3/4 flex flex-col'>
        ...
        <div className = 'SlateFont text-sm pb-1'>
          {role}
        </div>
        <ul>
          {
            description.map((bullet) => { return (
